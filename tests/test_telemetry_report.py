...
def test_report_counts_observed_events_and_completed_decisions():
    report = build_report([
...
def test_report_does_not_infer_missing_selection():
    report = build_report([
...
def test_report_does_not_turn_cancel_into_latency():
    report = build_report([
        _event(0, "action_choices_exposed", 1000, decision_id="d1", actions=[{"type": "move"}]),
