...
A identificação exata da revisão de `main` usada por uma experiência pertence ao próprio registo da experiência, CI/Artefacto ou proveniência do dataset — não a este documento canónico.
